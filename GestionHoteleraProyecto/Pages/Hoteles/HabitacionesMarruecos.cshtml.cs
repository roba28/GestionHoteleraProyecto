...
{
    public class HabitacionesMarruecosModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            // Lee el archivo de texto del Hotel Continental de Marruecos
            var lines = System.IO.File.ReadAllLines("HotelContinentalMarruecos.txt");
