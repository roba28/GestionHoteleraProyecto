...
{
    public class HabitacionesRomaModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            // Lee el archivo de texto del Hotel Continental de Roma
            var lines = System.IO.File.ReadAllLines("HotelContinentalRoma.txt");
